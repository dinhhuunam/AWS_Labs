...
4. Proceed to configure network settings.
    <img src="AWS_Labs/Jenkins/images/image-1.png">
...
2. Ensure port 8080 (Jenkins) and port 22 (SSH) are open.
    <img src="AWS_Labs/Jenkins/images/image-2.png">
...
2. Select the instance (my_jenkins_server)
    <img src="AWS_Labs/Jenkins/images/image-4.png">

# Step 7: Install Jenkins
1. Using bashscript jenkins-install.sh

👉 Jenkins runs on http://:8080 \
    <img src="AWS_Labs/Jenkins/images/image-3.png">

2. Get initial password: \
    ```sudo cat /var/lib/jenkins/secrets/initialAdminPassword```

    <img src="AWS_Labs/Jenkins/images/image-5.png">


    <img src="AWS_Labs/Jenkins/images/image-6.png">

    <img src="AWS_Labs/Jenkins/images/image-7.png">


    <img src="AWS_Labs/Jenkins/images/image-8.png">